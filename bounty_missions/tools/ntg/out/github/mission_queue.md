...
| review | 106 | tenstorrent/tt-metal | 52675 | C++ | Plausible bounty with enough detail to inspect manually. | bounty:bounty, action:root cause, action:error, task:fix | [open](https://github.com/tenstorrent/tt-metal/issues/52675) |
...
| pursue | 90 | SecureBananaLabs/bug-bounty | 11620 | JavaScript | Direct bounty signals, actionable issue details, and low competition risk. | bounty:bounty, bounty:/claim, platform:algora, action:expected behavior | [open](https://github.com/SecureBananaLabs/bug-bounty/issues/11620) |
