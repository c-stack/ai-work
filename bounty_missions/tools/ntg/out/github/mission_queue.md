...
| review | 80 | tenstorrent/tt-metal | 48287 | C++ | Possible bounty wording, but the issue reads partly like end-user support. | bounty:bounty, action:root cause, action:error, task:fix | [open](https://github.com/tenstorrent/tt-metal/issues/48287) |
| review | 79 | tenstorrent/tt-metal | 48285 | C++ | Bounty looks real, but active discussion increases takeover risk. | bounty:bounty, action:regression, claims:1 | [open](https://github.com/tenstorrent/tt-metal/issues/48285) |
| review | 73 | openmetaearth/me-hub | 1411 | TypeScript | Likely bounty, but the issue still needs manual scoping before coding. | bounty:bounty, action:expected behavior, task:bug, template-gaps:4 | [open](https://github.com/openmetaearth/me-hub/issues/1411) |
